...
```
intermediate/stocks_analysis/
├── 赛力斯/
│   ├── 赛力斯-2026-04-08-1430.md
│   ├── 赛力斯-2026-04-09-0915.md
│   └── 最新分析.md -> 赛力斯-2026-04-09-0915.md
└── 特斯拉/
    ├── 特斯拉-2026-04-08-1630.md
    └── 最新分析.md -> 特斯拉-2026-04-08-1630.md
```
...
4. **工作空间**：默认使用 `intermediate/stocks_analysis/` 目录

5. **环境变量**：可通过 `STOCK_INTERMEDIATE_DIR` 环境变量自定义目录
