...
| 成本保护 | 跌破成本价×0.985（亏1.5%）| 亏1.5%清仓，系统自动同步保护价 |
| 金额止损 | 亏损 5-10% | 金钱止损 |

**事件条件**（多实例，支持同类型多档）：
| 事件类型 | 触发信号 | 处理方式 | 类别 |
|---------|---------|---------|------|
| 利润保护-黄灯 | 从最高浮盈回撤 10% | 减仓 20% | soft |
| 利润保护-橙灯 | 从最高浮盈回撤 20% | 减仓 30% | soft |
| 利润保护-红灯 | 从最高浮盈回撤 30% | 减仓 50% | soft |
| 利润保护-黑灯 | 从最高浮盈回撤 50% | 清仓 | soft |
...
| 情况 | 止盈标准 | 处理方式 | 说明 |
|------|---------|---------|------|
| 目标价到达 | 触及分析报告目标价 | 减仓 20% | 让利润奔跑，不清仓 |
| 利润保护梯度 | 从最高浮盈回撤 | 10%/20%/30%/50% 对应减仓 | 动态分层保护 |
| 技术止盈 | 技术指标顶背离 | 减仓 30-50% | 趋势转弱信号 |
| 消息止盈 | 重大利好兑现 | 减仓 20-50% | 利好兑现 |
| 市场止盈 | 市场环境转弱 | 清仓 | 系统性风险 |

> **关键区别**：目标价到达只减仓20%，不清仓。除非同时触发更高优先级的技术破位或利润保护红灯。

```bash
# 目标价到达：只减仓20%，让利润奔跑
ptrade sell "股票" --qty 20 --note "目标价到达：减仓20%锁定部分利润，剩余让利润奔跑"

# 利润保护黄灯：回撤10%，减仓20%
ptrade sell "股票" --qty 20 --note "利润保护黄灯：从最高浮盈回撤10%，减仓20%"

# 利润保护黑灯：回撤50%，清仓
ptrade sell "股票" --qty 100 --note "利润保护黑灯：利润几乎回吐完，清仓离场"
